...
{
       0,    41,    41,    44,    45,    48,    48,    51,    52,    55,
      56,    59,    60,    63,    66,    67,    70,    70,    71,    72,
      73,    74,    75,    76,    77,    78,    78,    79,    80,    81,
      82,    82,    82,    82,    85,    88,    91,    94,    97,    98,
     101,   102,   105,   106,   107,   111,   112,   113,   114,   115,
...
#line 71 "parser.ypp" /* yacc.c:1646  */
    {prevDefCheck((yyvsp[-1])->name); addVarToSymTable((yyvsp[-2])->name, (yyvsp[-1])->name, 0); initVar((yyvsp[-1])->name);}
...
int main()
{
	...
	CodeBuffer::instance().addBegCodetoBuffer();
